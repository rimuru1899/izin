...
clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m          WELCOME TO SRICPT BY RIMURU TUNNELING            \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 1
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/rimuru1899/izin/main/ip"
rm -f /usr/bin/user
...
select_ARISCTUNNEL_domain() {
    echo "Selecting a Add Domain BY RIMURU TUNNELING..."
    # Gantilah dengan URL atau metode lain yang sesuai untuk mendapatkan domain acak
...
function pasang_domain() {
    ...
    echo -e "     \e[1;32m3)\e[0m Add Domain BY RIMURU TUNNELING"
    echo -e "   ------------------------------------"
    ...
    if [[ $host == "1" ]]; then
        ...
        if [[ -z "$nama" ]]; then
            echo "RIMURU TUNNELING" > /etc/xray/username
        else
...
function add_domain_by_arisctunnel() {
    ...
    echo ""
    echo -e "   \e[1;36m_______________________________$NC"
    echo -e "   \e[1;32m   ADD DOMAIN BY RIMURU TUNNELING $NC"
    echo -e "   \e[1;36m_______________________________$NC"
    echo -e ""
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/Brandal99999"},{"text":"Contact","url":"https://wa.me/6283120975728"}]]}'
...
#print_success "UDP-CUSTOM BY RIMURU TUNNELING"
}
function NOOBZVPNS(){
clear
...
#print_success "NOOBZVPNS BY RIMURU TUNNELING"
}
